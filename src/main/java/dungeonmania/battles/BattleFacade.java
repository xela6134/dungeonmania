...
public class BattleFacade {
    ...
    public void battle(Game game, Player player, Enemy enemy) {
        // 0. init
        double initialPlayerHealth = player.getBattleHealth();
        double initialEnemyHealth = enemy.getBattleHealth();
        ...
        if (effectivePotion != null) {
            ...
            for (Buffable item : player.getInventoryEntities(Buffable.class)) {
        ...
        player.setBattleHealth(playerBattleStatistics.getHealth());
        enemy.setBattleHealth(enemyBattleStatistics.getHealth());
